#!/usr/bin/env python3
"""
Part 2 Client: Reliable UDP File Transfer Client
Supports prefix filename parameter
"""
...
class ReliableUDPClient:
    ...
    def request_file(self):
        ...
        for attempt in range(MAX_REQUEST_RETRIES):
            ...
            try:
                ...
                print(f"[CLIENT] Received first packet")
                return pkt
    ...
    def receive_file(self):
        ...
        if data == b'EOF':
            print("[CLIENT] Empty file received")
        ...
        if seq == 0:
            ...
            # First packet out of order - buffer it
...
if __name__ == "__main__":
    ...
    client = ReliableUDPClient(sys.argv[1], int(sys.argv[2]), sys.argv[3])
    success = client.run()
